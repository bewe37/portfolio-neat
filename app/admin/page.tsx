  ...
  if (!authed) return (
    <div style={{
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 12, width: 280 }}>
        <p style={{ color: "rgba(255,255,255,0.7)", fontSize: 13, fontWeight: 600, margin: 0, letterSpacing: "-0.01em" }}>
        ...
        <button
          ...
          style={{
            ...
            color: "#0e0d0c", fontSize: 13, fontWeight: 700, cursor: loading ? "default" : "pointer",
    ...
    <div style={{ minHeight: "100dvh", background: "#0e0d0c", fontFamily: "var(--font-sans)", padding: "40px 32px" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 28 }}>
          <div>
            <p style={{ color: "#fff", fontSize: 16, fontWeight: 700, margin: "0 0 4px", letterSpacing: "-0.02em" }}>
        ...
        {companions.length === 0 ? (
          <p style={{ color: "rgba(255,255,255,0.3)", fontSize: 13 }}>No drawings yet.</p>
        ) : (
