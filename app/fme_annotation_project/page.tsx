...
export default function FmeProject() {
  return (
    <CaseStudyLayout
      ...
      specs={[
        { label: "Contributions", value: ["UX / UI Design", "Prototyping", "Usability testing", "Design system expansion", "Engineering handoff"] },
        { label: "Team",          value: ["1 Design Lead", "3 Engineers", "1 Product Manager"] },
        { label: "Duration",      value: "Apr – Aug 2024" },
      ]}
      sections={[
        {
          label: "The Impact",
        ...
        },
        {
          ...
          title: "Creating a more comprehensive annotation system.",
        ...
        },
        {
          ...
          body:  "The annotation in the parameter dialog has been released and is now available to users. However, the annotation visibility feature is on hold due to capacity constraints — it has been prioritized for future development and remains on the Product Planning page.",
        },
        {
          label: "Retrospective",
          contents: [
