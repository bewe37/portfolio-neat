  ...
  return (
    ...
    <CaseStudyLayout
      ...
      sections={[
        {
          label: "Context",
          title: "A tool meant to help, that started to get in the way.",
          body: "During my internship at Safe Software, I led the end-to-end redesign of the annotation experience in FME Form, a data integration platform used to build complex spatial workflows.\n\nAnnotations are notes users can place directly on the canvas to add context, explain decisions, or document logic within a workflow. They come in two forms:",
          contents: [
            {
              highlight: true,
              title: "Custom Annotations.",
              body:  "Created manually by users. They have full control over the content, allowing them to document logic, explain decisions, or leave notes for their future selves.",
              image: "/Custom.png",
            },
            {
              highlight: true,
              title: "Summary Annotations.",
              body:  "Auto-generated by the software. Contents are predefined and describe what an object does, but not why it's configured a certain way.",
              image: "/Summary.png",
            },
          ],
        },
